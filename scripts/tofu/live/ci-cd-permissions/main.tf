...
module "oidc_provider" {
  source = "github.com/Magloire07/td5//tofu/modules/github-aws-oidc"
...
module "iam_roles" {
  source = "github.com/Magloire07/td5//tofu/modules/gh-actions-iam-roles"
